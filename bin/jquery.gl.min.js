...
e=a.direction.elements;a=c[0];var f=c[1],c=c[2],g=e[0],k=e[1],e=e[2],l=b[0]-d[0],n=b[1]-d[1],d=b[2]-d[2],m=g*g+k*k+e*e,p=a*g+f*k+c*e,g=((-a*l-f*n-c*d)*m/(a*a+f*f+c*c)+p*(g*l+k*n+e*d))/(m-p*p);return h.create([b[0]+g*a,b[1]+g*f,b[2]+g*c])},pointClosestTo:function(a){if(a.direction){if(this.intersects(a))return this.intersectionWith(a);if(this.isParallelTo(a))return null;var b=this.direction.elements,c=a.direction.elements,d=b[0],e=b[1],b=b[2],f=c[0],g=c[1],k=c[2],c=b*f-d*k,l=d*g-e*f,m=e*k-b*g,d=h.create([c*
k-l*g,l*f-m*k,m*g-c*f]);a=n.create(a.anchor,d);return a.intersectionWith(this)}a=a.elements||a;if(this.contains(a))return h.create(a);c=this.anchor.elements;b=this.direction.elements;d=b[0];e=b[1];b=b[2];f=c[0];l=c[1];g=c[2];c=d*(a[1]-l)-e*(a[0]-f);l=e*((a[2]||0)-g)-b*(a[1]-l);m=b*(a[0]-f)-d*((a[2]||0)-g);d=h.create([e*c-b*m,b*l-d*c,d*m-e*l]);e=this.distanceFrom(a)/d.modulus();return h.create([a[0]+d.elements[0]*e,a[1]+d.elements[1]*e,(a[2]||0)+d.elements[2]*e])},rotate:function(a,b){"undefined"==
typeof b.direction&&(b=q.create(b.to3D(),h.k));var c=l.Rotation(a,b.direction).elements,d=b.pointClosestTo(this.anchor).elements,e=this.anchor.elements,f=this.direction.elements,g=d[0],k=d[1],d=d[2],m=e[0]-g,n=e[1]-k,e=e[2]-d;return q.create([g+c[0][0]*m+c[0][1]*n+c[0][2]*e,k+c[1][0]*m+c[1][1]*n+c[1][2]*e,d+c[2][0]*m+c[2][1]*n+c[2][2]*e],[c[0][0]*f[0]+c[0][1]*f[1]+c[0][2]*f[2],c[1][0]*f[0]+c[1][1]*f[1]+c[1][2]*f[2],c[2][0]*f[0]+c[2][1]*f[1]+c[2][2]*f[2]])},reflectionIn:function(a){if(a.normal){var b=
this.anchor.elements,c=this.direction.elements,d=b[0],e=b[1],b=b[2],f=c[0],g=c[1],k=c[2],c=this.anchor.reflectionIn(a).elements,d=d+f,e=e+g,b=b+k;a=a.pointClosestTo([d,e,b]).elements;return q.create(c,[a[0]+(a[0]-d)-c[0],a[1]+(a[1]-e)-c[1],a[2]+(a[2]-b)-c[2]])}if(a.direction)return this.rotate(Math.PI,a);a=a.elements||a;return q.create(this.anchor.reflectionIn([a[0],a[1],a[2]||0]),this.direction)},setVectors:function(a,b){a=h.create(a);b=h.create(b);2==a.elements.length&&a.elements.push(0);2==b.elements.length&&
b.elements.push(0);if(3<a.elements.length||3<b.elements.length)return null;var c=b.modulus();if(0===c)return null;this.anchor=a;this.direction=h.create([b.elements[0]/c,b.elements[1]/c,b.elements[2]/c]);return this}};q.create=function(a,b){return(new q).setVectors(a,b)};q.X=q.create(h.Zero(3),h.i);q.Y=q.create(h.Zero(3),h.j);q.Z=q.create(h.Zero(3),h.k);n.prototype={eql:function(a){return this.contains(a.anchor)&&this.isParallelTo(a)},dup:function(){return n.create(this.anchor,this.normal)},translate:function(a){a=
...
(b[1]-a[1])*c[1]+(b[2]-(a[2]||0))*c[2];return h.create([a[0]+c[0]*b,a[1]+c[1]*b,(a[2]||0)+c[2]*b])},rotate:function(a,b){var c=l.Rotation(a,b.direction).elements,d=b.pointClosestTo(this.anchor).elements,e=this.anchor.elements,f=this.normal.elements,g=d[0],k=d[1],d=d[2],h=e[0]-g,m=e[1]-k,e=e[2]-d;return n.create([g+c[0][0]*h+c[0][1]*m+c[0][2]*e,k+c[1][0]*h+c[1][1]*m+c[1][2]*e,d+c[2][0]*h+c[2][1]*m+c[2][2]*e],[c[0][0]*f[0]+c[0][1]*f[1]+c[0][2]*f[2],c[1][0]*f[0]+c[1][1]*f[1]+c[1][2]*f[2],c[2][0]*f[0]+
c[2][1]*f[1]+c[2][2]*f[2]])},reflectionIn:function(a){if(a.normal){var b=this.anchor.elements,c=this.normal.elements,d=b[0],e=b[1],b=b[2],f=c[0],g=c[1],h=c[2],c=this.anchor.reflectionIn(a).elements,d=d+f,e=e+g,b=b+h;a=a.pointClosestTo([d,e,b]).elements;return n.create(c,[a[0]+(a[0]-d)-c[0],a[1]+(a[1]-e)-c[1],a[2]+(a[2]-b)-c[2]])}if(a.direction)return this.rotate(Math.PI,a);a=a.elements||a;return n.create(this.anchor.reflectionIn([a[0],a[1],a[2]||0]),this.normal)},setVectors:function(a,b,c){a=h.create(a);
a=a.to3D();if(null===a)return null;b=h.create(b);b=b.to3D();if(null===b)return null;if("undefined"==typeof c)c=null;else if(c=h.create(c),c=c.to3D(),null===c)return null;var d=a.elements[0],e=a.elements[1],f=a.elements[2],g=b.elements[0],k=b.elements[1],l=b.elements[2];if(null!==c){b=c.elements[0];var m=c.elements[1];c=c.elements[2];e=h.create([(k-e)*(c-f)-(l-f)*(m-e),(l-f)*(b-d)-(g-d)*(c-f),(g-d)*(m-e)-(k-e)*(b-d)]);d=e.modulus();if(0===d)return null;e=h.create([e.elements[0]/d,e.elements[1]/d,e.elements[2]/
d])}else{d=Math.sqrt(g*g+k*k+l*l);if(0===d)return null;e=h.create([b.elements[0]/d,b.elements[1]/d,b.elements[2]/d])}this.anchor=a;this.normal=e;return this}};n.create=function(a,b,c){return(new n).setVectors(a,b,c)};n.XY=n.create(h.Zero(3),h.k);n.YZ=n.create(h.Zero(3),h.i);n.ZX=n.create(h.Zero(3),h.j);n.YX=n.XY;n.ZY=n.YZ;n.XZ=n.ZX;var w=h.create,y=l.create;u.fn.gl=function(a){if(0==this.length)return this;var b=this[0],c=null;if(b._jquery_gl)if(c=b._jquery_gl,a)alert("Re-wrapping a wrapped gl context not supported.");
else return c;else{var d=this[0],e=null;try{(e=d.getContext("webgl"))||(e=d.getContext("experimental-webgl"))}catch(f){alert("Error creating webgl context: "+f)}e||alert("Failed to create webgl context.");c=e;b._jquery_gl=c}b=c;b.m=new s;b.x=new r(b);b.util=new A(b);a&&(a.init&&a.init(c),a.draw&&(c.x.draw(a.draw),a.draw(c)),a.update&&c.x.update(a.update),a.framerate&&0<a.framerate&&setInterval(function(){c.x.frame()},1E3/a.framerate));c.x.info=E;return c}})(jQuery);