...
new Uint16Array(a),b.STATIC_DRAW);this._elementArray=buffer};d.prototype.draw=function(){var a=this._gl;a.useProgram(this._material.prog);this._setAttributes();this._material.setTextures();this._material.setUniforms();this._elementArray?a.drawElements(this._type,this._vert_length,a.UNSIGNED_SHORT,0):a.drawArrays(this._type,0,this._vert_length)};var f=function(a){var b=null;try{(b=a.getContext("webgl"))||(b=a.getContext("experimental-webgl"))}catch(c){alert("Error creating webgl context: "+c)}b||alert("Failed to create webgl context.");
return b},g=function(b,c){var d=a("#"+c),e=d.text();if(!e||e=="")return alert("Unable to find source for shader: "+c),null;var d=d.attr("type"),f=null;if(d=="x-shader/x-vertex")f=b.createShader(b.VERTEX_SHADER);else if(d=="x-shader/x-fragment")f=b.createShader(b.FRAGMENT_SHADER);else return alert('Shader script must have type "x-shader/x-fragment" or "x-shader/x-vertex"'),null;b.shaderSource(f,e);b.compileShader(f);return!b.getShaderParameter(f,b.COMPILE_STATUS)?(alert("Shader compilation failed: "+
c+": "+b.getShaderInfoLog(f)),null):f};e.prototype.createModel=function(a,b,c){model=new d(this._gl,a,b,c);this._models.push(model);return model};e.prototype.createMaterial=function(a,c){var d=this._gl,e=g(d,a),f=g(d,c),h;prog=d.createProgram();d.attachShader(prog,e);d.attachShader(prog,f);d.linkProgram(prog);d.getProgramParameter(prog,d.LINK_STATUS)||alert("Shader program link failed: "+d.getProgramInfoLog(prog));d.deleteShader(e);d.deleteShader(f);(h=prog)||alert("Failed to create program: "+e+
", "+f);return this.currentMaterial=new b(h,d)};e.prototype.initDepth=function(a){a||(a=1);var b=this._gl;b.clearColor(0,0,0,1);b.clearDepth(a);b.enable(b.DEPTH_TEST);b.depthFunc(b.LEQUAL)};e.prototype.models=function(a){return typeof a=="number"?this._models[a]:this._models[0]};var h=function(a){a.m=new c;a.x=new e(a)};a.fn.gl=function(a){if(this.length==0)return this;var b=this[0],c=null;b._jquery_gl?c=b._jquery_gl:(c=f(this[0]),b._jquery_gl=c);h(c);a.init&&a.init(c);a.draw&&(a.framerate&&a.framerate>
0?setInterval(function(){a.draw(c)},1E3/a.framerate):a.draw(c));return c}})(jQuery);
