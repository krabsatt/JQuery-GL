...
name),a),a++};b.prototype.setUniforms=function(){var a=this._gl;for(name in this._uniforms){var b=this._uniforms[name];if(b==this.DefaultMatrix.M)b=a.m.m;else if(b==this.DefaultMatrix.P)b=a.m.p;else if(b==this.DefaultMatrix.C)b=a.m.c;var c=a.getUniformLocation(this.prog,name);c||alert("Unable to find uniform name "+name+" in shaders.");for(var d=[],e=0;e<4;++e)for(var f=0;f<4;++f)d.push(b.elements[f][e]);a.uniformMatrix4fv(c,!1,new Float32Array(d))}};c.prototype.lookAt=function(a,b,c){var c=$V(c).toUnitVector(),
b=$V(b).toUnitVector(),c=b.cross(c),d=c.cross(b);this.c=$M([[c.elements[0],c.elements[1],c.elements[2],0],[d.elements[0],d.elements[1],d.elements[2],0],[-b.elements[0],-b.elements[1],-b.elements[2],0],[0,0,0,1]]).x(this.c);this.c=f($V(a).x(-1)).x(this.c)};c.prototype.perspective=function(a,b,c,d,e){c=c*1/d;d=2*a*Math.tan(e*Math.PI/360);return this.p=$M([[2*a/(c*d),0,0,0],[0,2*a/d,0,0],[0,0,-(b+a)/(b-a),-2*b*a/(b-a)],[0,0,-1,0]])};c.prototype.push=function(){this._stack.push(this.m.dup())};c.prototype.pop=
function(){this.m=this._stack.pop()};c.prototype.apply=function(a){return this.m=a.x(this.m)};c.prototype.identity=function(){return this.m=Matrix.I(4)};c.prototype.i=function(){return this.identity()};var f=function(a){for(var b=Matrix.I(4),c=0;c<a.length;++c)b.elements[c][3]=a[c];return b};c.prototype.translate=function(a){a=f(a);this.apply(a);return a};c.prototype.rotate=function(a,b){var a=a*Math.PI/180,b=$V(b).toUnitVector(),c=b.elements[0],d=b.elements[1],e=b.elements[2],f=Math.cos(a),g=Math.sin(a),
h=1-f,c=$M([[h*c*c+f,h*c*d-g*e,h*c*e+g*d,0],[h*c*d+g*e,h*d*d+f,h*d*e-g*c,0],[h*c*e-g*d,h*d*e+g*c,h*e*e+f,0],[0,0,0,1]]);this.apply(c);return c};d.prototype._setAttributes=function(){for(i=0;i<this._buffers.length;++i){attr=this._buffers[i].attr;buffer=this._buffers[i].buffer;l=this._buffers[i].l;var a=this._gl;a.bindBuffer(a.ARRAY_BUFFER,buffer);a.vertexAttribPointer(attr,l,a.FLOAT,!1,0,0);a.enableVertexAttribArray(attr)}this._elementArray&&a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,this._elementArray)};
d.prototype.addAttribute=function(a,b,c){var d=this._gl;c||(c=3);var e=d.getAttribLocation(this._material.prog,b);e==-1&&alert("Unable to find attribute name "+b+" in shaders.");b=d.createBuffer();d.bindBuffer(d.ARRAY_BUFFER,b);d.bufferData(d.ARRAY_BUFFER,new Float32Array(a),d.STATIC_DRAW);this._buffers.push({attr:e,buffer:b,l:c})};d.prototype.addElementArray=function(a){var b=this._gl;buffer=b.createBuffer();b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,buffer);b.bufferData(b.ELEMENT_ARRAY_BUFFER,new Uint16Array(a),
b.STATIC_DRAW);this._elementArray=buffer};d.prototype.useOrientation=function(){this.o=this.orientation=new c;this.o.perspective=void 0};d.prototype.draw=function(){var a=this._gl;this.o&&(a.m.push(),a.m.apply(this.o.m));a.useProgram(this._material.prog);this._setAttributes();this._material.setTextures();this._material.setUniforms();this.o&&a.m.pop();this._elementArray?a.drawElements(this._type,this._vert_length,a.UNSIGNED_SHORT,0):a.drawArrays(this._type,0,this._vert_length)};var g=function(a){var b=
null;try{(b=a.getContext("webgl"))||(b=a.getContext("experimental-webgl"))}catch(c){alert("Error creating webgl context: "+c)}b||alert("Failed to create webgl context.");return b},h=function(b,c){var d=a("#"+c),e=d.text();if(!e||e=="")return alert("Unable to find source for shader: "+c),null;var d=d.attr("type"),f=null;if(d=="x-shader/x-vertex")f=b.createShader(b.VERTEX_SHADER);else if(d=="x-shader/x-fragment")f=b.createShader(b.FRAGMENT_SHADER);else return alert('Shader script must have type "x-shader/x-fragment" or "x-shader/x-vertex"'),
null;b.shaderSource(f,e);b.compileShader(f);return!b.getShaderParameter(f,b.COMPILE_STATUS)?(alert("Shader compilation failed: "+c+": "+b.getShaderInfoLog(f)),null):f};e.prototype.createModel=function(a,b,c){model=new d(this._gl,a,b,c);this._models.push(model);return model};e.prototype.createMaterial=function(a,c){var d=this._gl,e=h(d,a),f=h(d,c),g;prog=d.createProgram();d.attachShader(prog,e);d.attachShader(prog,f);d.linkProgram(prog);d.getProgramParameter(prog,d.LINK_STATUS)||alert("Shader program link failed: "+
d.getProgramInfoLog(prog));d.deleteShader(e);d.deleteShader(f);(g=prog)||alert("Failed to create program: "+e+", "+f);return this.currentMaterial=new b(g,d)};e.prototype.initDepth=function(a){a||(a=1);var b=this._gl;b.clearColor(0,0,0,1);b.clearDepth(a);b.enable(b.DEPTH_TEST);b.depthFunc(b.LEQUAL)};e.prototype.models=function(a){return typeof a=="number"?this._models[a]:this._models[0]};var k=function(a){a.m=new c;a.x=new e(a)};a.fn.gl=function(a){if(this.length==0)return this;var b=this[0],c=null;
b._jquery_gl?c=b._jquery_gl:(c=g(this[0]),b._jquery_gl=c);k(c);a.init&&a.init(c);a.draw&&(a.framerate&&a.framerate>0?setInterval(function(){a.draw(c)},1E3/a.framerate):a.draw(c));return c}})(jQuery);var Sylvester={version:"0.1.3",precision:1.0E-6};function Vector(){}
